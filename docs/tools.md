...
We build interactive AI tools for the classroom. They run as a separate web app,
so you can open them straight from here. No installation and no account needed.

!!! note "The app may take a moment to wake up"
    The app is hosted on a free service that puts it to sleep when nobody is
    using it. The first visit can take up to a minute to load. After that it is
    quick.
...
-   :material-school:{ .lg .middle } **AI Tutors**
    ...
    Pre-prompted subject tutors that students chat with. Includes **Emmy**, a
    Socratic physics research tutor who guides students through their own
    experiment in five stages, and a **Debate a Historical Figure** role-play
    tutor.
...
[Open the app :material-open-in-new:](https://scientificailab.streamlit.app){ .md-button .md-button--primary }
